...
-- OS検出: MacではSUPER(Cmd)、Windows/LinuxではALTを使用
local is_mac = wezterm.target_triple:find("darwin") ~= nil
local mod_key = is_mac and "SUPER" or "ALT"
...
return {
	keys = {
		...
		-- タブ切替 Mac: Cmd + 数字, Windows/Linux: Alt + 数字
		...
		{ key = "9", mods = mod_key, action = act.ActivateTab(-1) },
